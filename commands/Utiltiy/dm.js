...
module.exports = {
    ...
    requiredRoles: ["813837707393761300","832747239809613834"],
    ...
    callback: async (message,args,text,prefix) => {
        ...
        mentionmember.send({content: msg}).then(async (sendmsg) => {
            message.channel.send({content: `${mentionmember} get dmed noob.`,allowedMentions: {parse: []}})
